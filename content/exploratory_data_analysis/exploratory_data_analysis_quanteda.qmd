...
dfmat_bigrams_trim <- dfm_trim(bigram_trim, min_termfreq = 3000, termfreq_type = "rank")
...
fwrite(convert_bigrams_tfidf, here::here("data", "model_data", "tfidf_bigram_df.csv.gz"))
```
