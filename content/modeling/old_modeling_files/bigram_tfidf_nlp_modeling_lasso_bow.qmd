...
here::i_am("content/modeling/bigram_tfidf_nlp_modeling_lasso_bow.qmd")
library(tidymodels)
...
tidytable::fwrite(lasso_variables, here::here("content", "modeling", "model_results", "lasso_variables_bow_first_run_4k.csv"))
...
ggsave("variable_importance_plot_lasso_bow.png")
```

```{r}
lasso_test_preds <- augment(fitted_lasso, new_data = bigram_test)

tidytable::fwrite(lasso_test_preds, here::here("content", "modeling", "model_results", "lasso_test_preds_bow.csv"))
...
ggsave("roc_curve_lasso_bow.png")
```
