...
```{r}
last_fit_naivebayes <- last_fit(tune_wf, tfidf_split)

naivebayes_metric <- last_fit_naivebayes |>
  collect_predictions() |>
  class_metrics(source_bias, estimate = .pred_class, `.pred_left-wing`)

# tidytable::fwrite(naivebayes_metric, here::here("content","modeling", "model_results", "naivebayes_test_metrics_tfidf.csv"))

fit_predictions <- last_fit_naivebayes |>
  collect_predictions()

tidytable::fwrite(fit_predictions, here::here("content","modeling", "model_results", "naivebayes_test_predictions_tfidf.csv"))
...
ggsave(here::here("content", "modeling", "plots", "confusion_matrix_naivebayes_tfidf.png"))
```
