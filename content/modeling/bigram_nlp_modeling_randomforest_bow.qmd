...
here::i_am("content/modeling/bigram_nlp_modeling_randomforest_bow.qmd")
library(tidymodels)
...
readr::write_rds(tune_rs, "model_data/tune_results_randomforest_bow.rds")
```
...
tidytable::fwrite(randomforest_rs_metrics, here::here("content", "modeling", "model_results", "randomforest_rs_metrics_bow_bigrams_4k.csv"))
...
ggsave("plots/cv_metrics_randomforest_bow.png")
```
...
ggsave("plots/variable_importance_plot_randomforest_bow.png")
```

```{r}
last_fit_randomforest <- last_fit(final_randomforest, bow_split)

randomforest_metric <- last_fit_randomforest |>
  collect_predictions() |>
  class_metrics(source_bias, estimate = .pred_class, `.pred_left-wing`)

tidytable::fwrite(randomforest_metric, "model_results/randomforest_test_metrics_bow.csv")
...
ggsave("plots/roc_curve_randomforest_bow.png")
...
ggsave("plots/confusion_matrix_randomforest_bow.png")
```
