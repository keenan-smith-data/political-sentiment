...
ggsave("plots/cv_metrics_lasso_lsa.png")
```
...
ggsave("plots/variable_importance_plot_lasso_lsa.png")
```
...
ggsave("plots/roc_curve_lasso_lsa.png")
...
ggsave("plots/confusion_matrix_lasso_lsa.png")
```
