...
here::i_am("content/modeling/bigram_nlp_modeling_randomforest_tfidf.qmd")
library(tidymodels)
...
readr::write_rds(tune_rs, here::here("content","modeling", "model_results", "tune_results_randomforest_tfidf.rds"), compress = "gz")
...
tidytable::fwrite(randomforest_rs_metrics, here::here("content", "modeling", "model_results", "randomforest_rs_metrics_tfidf_bigrams.csv"))
...
ggsave("plots/cv_metrics_randomforest_tfidf.png")
```
...
ggsave("plots/variable_importance_plot_randomforest_tfidf.png")
```

```{r}
last_fit_randomforest <- last_fit(final_randomforest, tfidf_split)

randomforest_metric <- last_fit_randomforest |>
  collect_predictions() |>
  class_metrics(source_bias, estimate = .pred_class, `.pred_left-wing`)

tidytable::fwrite(randomforest_metric, here::here("content","modeling", "model_results", "randomforest_test_metrics_tfidf.csv"))
...
ggsave("plots/roc_curve_randomforest_tfidf.png")
...
ggsave("plots/confusion_matrix_randomforest_tfidf.png")
```
