...
source_create <- create_source_table("source_table", pol_sent_db)

DBI::dbExecute(pol_sent_db, linkcheck_create)
DBI::dbExecute(pol_sent_db, sitemap_create)
DBI::dbExecute(pol_sent_db, source_create)
```
...
copy_source_table <- copy_table("source_table", here::here("data", "sources", "source_table.csv"), pol_sent_db)

DBI::dbExecute(pol_sent_db, copy_linkcheck)
DBI::dbExecute(pol_sent_db, copy_sitemap)
DBI::dbExecute(pol_sent_db, copy_source_table)
```
